...
/**
 * @author Sera Jeong 12211242 Created Date: 07/09/2024
 */

@WebServlet("/admin/review_hide")
public class ReviewHideServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (reviewId != null && !reviewId.trim().isEmpty()) {
            adminReviewServices.hideReview(reviewId);
