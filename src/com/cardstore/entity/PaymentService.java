...
@NamedQueries({
	@NamedQuery(name = "PaymentService.findAll", query = "SELECT ps from PaymentService ps ORDER BY ps.paymentServiceId"),	
	@NamedQuery(name = "PaymentService.countAll", query = "SELECT Count(*) FROM PaymentService ps")	
})
