...
<body>
	...
	<div class="container">
		...
		<!-- Review form -->
		<form action="review_add_save" method="post"
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<select name="sellerId" class="form-control" required>
						<option value="" disabled selected>Select seller name
							here...</option>
						<c:forEach var="seller" items="${sellers}">
							<option value="${seller.userId}">${seller.firstName}
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="number" name="rating" class="form-control" min="1"
						max="5" step="0.1" value="${review.rating}" required />
				</div>
			</div>
