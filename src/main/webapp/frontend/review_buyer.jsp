    ...
    <div class="container flex-grow-1">
        ...
        <div class="row">
            <div class="col text-center">
                <h2>Buyer Reviews</h2>
                <p>You can leave reviews and ratings about the sellers from your card purchases here.</p>
                <hr class="my-4">
                <div>
...
<%--                             
                                ...
                                <td>
                                    <a href="review_update?id=${review.reviewId}" class="btn btn-warning btn-sm">Update</a>
                                    <a href="review_delete?id=${review.reviewId}" class="btn btn-danger btn-sm">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
